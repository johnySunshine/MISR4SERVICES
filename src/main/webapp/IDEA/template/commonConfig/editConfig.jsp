                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-line-form" action="<%=basePath%>CustomConfig/UpdateConfig"
                                  method="POST">

                                <div class="am-form-group">
                                    <label for="user-id" class="am-u-sm-3 am-form-label">ID <span
                                            class="tpl-form-line-small-title">KEY</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="user-id" name="key"
                                               placeholder="请输入KEY" readonly value="${cusConfig.id}">
                                        <small>请输入KEY大写字母。</small>
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label for="user-key" class="am-u-sm-3 am-form-label">配置的KEY值 <span
                                            class="tpl-form-line-small-title">KEY</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="user-key" name="key"
                                               placeholder="请输入KEY" value="${cusConfig.key}">
                                        <small>请输入KEY大写字母。</small>
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label for="value" class="am-u-sm-3 am-form-label">配置的Value值 <span
                                            class="tpl-form-line-small-title">Value</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="value" class="am-form-field tpl-form-no-bg"
                                               name="value" placeholder="请输入Value值" value="${cusConfig.value}">
                                        <small>Value值</small>
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label for="user-type" class="am-u-sm-3 am-form-label">属于用户类型 <span
