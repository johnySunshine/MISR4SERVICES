...
<link rel="icon" type="image/png" href="<%=IDEAPath%>assets/i/favicon.png">
<link rel="apple-touch-icon-precomposed" href="<%=IDEAPath%>assets/i/app-icon72x72@2x.png">
<meta name="apple-mobile-web-app-title" content="M-Stream 后端管理"/>
<%--<script src="<%=IDEAPath%>assets/js/echarts.min.js"></script>--%>
<link rel="stylesheet" href="<%=IDEAPath%>assets/css/animate.min.css">
<link rel="stylesheet" href="<%=IDEAPath%>assets/css/amazeui.min.css"/>
